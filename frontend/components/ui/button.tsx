...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-accent-orange text-white hover:bg-accent-orange-dim",
        destructive: "bg-accent-red text-white hover:bg-accent-red/90",
        outline:
          "border border-accent-orange text-accent-orange hover:bg-accent-orange/10",
        secondary:
          "bg-bg-secondary text-text-primary hover:bg-bg-card-hover",
        ghost: "hover:bg-bg-card-hover",
